...
export default function ProductInfo(props: ProductInfoProps) {
  ...
  const isOwner = createMemo(() => {
    ...
    return Number(props.currentUserId) === Number(props.product.owner_id);
  });

  const shouldShowRequestButton = () => props.currentUserId !== null && !isOwner();
  ...
  return (
    <div class="flex flex-col h-full">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{props.product.name}</h1>

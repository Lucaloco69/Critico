  ...
  return (
    <div class="text-center py-20 px-4">
      ...
      <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">
        {props.searchQuery() ? t("messagesEmptyChatsState.noResultsTitle") : t("messagesEmptyChatsState.noChatsTitle")}
      </h3>

      <p class="text-gray-600 dark:text-gray-400 mb-6">
        {props.searchQuery() ? t("messagesEmptyChatsState.noResultsText") : t("messagesEmptyChatsState.noChatsText")}
      </p>
      ...
      <Show when={!props.searchQuery()}>
        ...
        >
          ...
          {t("messagesEmptyChatsState.toHome")}
        </A>
      </Show>
    </div>
  );
